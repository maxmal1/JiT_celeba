...
from utils import VisionRotaryEmbeddingFast, get_2d_sincos_pos_embed, RMSNorm
...
class LabelEmbedder(nn.Module):
    ...
    def __init__(self, num_classes, hidden_size):
        super().__init__()
        # we can safely remove the `+1` that was here because no classes. for posterity we keep
        # num_classes at 1
